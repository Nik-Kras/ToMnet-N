...
#      pdb.set_trace()
      ...
      with tf.compat.v1.variable_scope(str(model_prefix + 'conv_before_resnet'), reuse = reuse):
      ...
      for i in range(n):
          with tf.compat.v1.variable_scope(str(model_prefix + 'conv_%d' %i), reuse=reuse):
              # --------------------------------------------------------------
              # Paper codes
      ...
      # --------------------------------------------------------------
      # pdb.set_trace()
      with tf.compat.v1.variable_scope(str(model_prefix + 'conv_prediction_head_layer'), reuse = reuse):
      ...
      # --------------------------------------------------------------
      with tf.compat.v1.variable_scope(str(model_prefix + 'average_pooling'), reuse=reuse):
      ...
      #   '''
      # --------------------------------------------------------------
      with tf.compat.v1.variable_scope(str(model_prefix + 'fc'), reuse=reuse):
          # layers[-1] = (16, 64)
