...
def predict_game(model, input_data, predict_steps=5, cnt=1):
...
if __name__ == "__main__":
    ...
    #predict_game(model, input_data_traj, predict_steps=12)

    # predict_game(model, input_data_traj, predict_steps=11)
    #
    # predict_game(model, input_data_traj, predict_steps=10)
    #
    cnt = 1
    predict_game(model, input_data_traj, predict_steps=9, cnt=cnt)
    cnt = cnt + 1

    predict_game(model, input_data_traj, predict_steps=8, cnt=cnt)
    cnt = cnt + 1

    predict_game(model, input_data_traj, predict_steps=7, cnt=cnt)
    cnt = cnt + 1
